...
def get_data(url):
    ...
    # movies = soup.find("div", class_="EventList__EventListWrap-sc-14wck6-2 kxVNGK")
    # with open("movies.html", 'w', encoding='utf-8') as f:
    #     f.write(str(movies))

    movies = soup.find_all('div', class_="sc-bczRLJ sc-gsnTZi bOvxGB jnFvAE event-info")
    print(movies)
    with open("movieEvery.html", 'w', encoding='utf-8') as f:
        f.write(str(movies))
